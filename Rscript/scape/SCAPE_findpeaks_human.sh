...
LOG_FILE="/mnt/T20T-6d12/BXY/scAPA/sim_data/PAC/human_GSM4712885/scape/performance_log.txt"
...
cd /mnt/T20T-6d12/BXY/scAPA/sim_data/SRA/human_GSM4712885
for sample in pas1_gn5000_bn3000_rep1 pas1_gn3000_bn2000_rep2 pas1_gn5000_bn3000_rep3 ;
do echo $sample;
  ...
  /usr/bin/time -f "峰值内存: %M KB\n平均内存: %K KB\nCPU使用率: %P\n运行时长: %e秒" \
    -a -o "$LOG_FILE" \
python /mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/scAPA/scAPA_tools/SCAPE-main/main.py apamix --bed /mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/ref_file/GRch38fa+gtf/genecode/v34/SCAPE_bed/GRCh38_v34_utr.bed --bam ${sample}.bam --out /mnt/T20T-6d12/BXY/scAPA/sim_data/PAC/human_GSM4712885/scape/${sample} --cores 12 --cb /mnt/T20T-6d12/BXY/scAPA/sim_data/SRA/human_GSM4712885/${sample}.barcode_list.txt
