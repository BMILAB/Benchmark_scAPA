...
LOG_FILE="/mnt/T20T-6d12/BXY/scAPA/sim_data/PAC/mouse_sperm/scape/performance_log.txt"
...
cd /mnt/T20T-6d12/BXY/scAPA/sim_data/SRA/mouse_sperm
...
do echo $sample;
  ...
  /usr/bin/time -f "峰值内存: %M KB\n平均内存: %K KB\nCPU使用率: %P\n运行时长: %e秒" \
    -a -o "$LOG_FILE" \
python /mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/scAPA/scAPA_tools/SCAPE-main/main.py apamix --bed /mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/ref_file/GRcm38fa+gtf/SCAPE_bed/GRCm38_v25_utr.bed --bam ${sample}.bam --out /mnt/T20T-6d12/BXY/scAPA/sim_data/PAC/mouse_sperm/scape/${sample} --cores 12 --cb /mnt/T20T-6d12/BXY/scAPA/sim_data/SRA/mouse_sperm/${sample}.barcode_list.txt
