...
#output dir
cd /mnt/T20T-d2bf/BXY/scAPA/sim.data/PAC/human_GSM4712885/scapture
...
do echo $sample;
mkdir /mnt/T20T-d2bf/BXY/scAPA/sim.data/PAC/human_GSM4712885/scapture/${sample};
cd /mnt/T20T-d2bf/BXY/scAPA/sim.data/PAC/human_GSM4712885/scapture/${sample}

### Run scapture PAScall module	

scapture -m PAScall -a /mnt/user/BXY/ref_file/GRch38fa+gtf/genecode/v34/SCAPTURE_anno/SCAPTURE_annotation -g /mnt/user/BXY/ref_file/GRch38fa+gtf/genecode/v34/GRCh38.p13.genome.fa -b /mnt/T20T-d2bf/BXY/scAPA/sim.data/SRA/human_GSM4712885/${sample}.bam  -l 91 -o ${sample} -p 12 --species human --polyaDB /mnt/user/BXY/ref_file/refPAC/SupTab_KnownPASs_fourDBs.txt &> ${sample}.PAScall.log;
...
scapture -m PASquant -b /mnt/T20T-d2bf/BXY/scAPA/sim.data/SRA/human_GSM4712885/${sample}.bam --celllist /mnt/T20T-d2bf/BXY/scAPA/sim.data/SRA/human_GSM4712885/${sample}.barcode_list.txt --pas ${sample}_ALL.PASquant.bed -o ${sample}.PASquant &> ${sample}.PASquant.log;
