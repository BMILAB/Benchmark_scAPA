...
#output folder
cd /media/ubantu_root/16TB_21/BXY/scAPA/PAC/mouse_sperm/scraps/merge/sim_data_res
#mkdir pas1_gn5000_bn2000_rep1 pas1_gn5000_bn2000_rep2 pas1_gn5000_bn2000_rep3

# Set the log file path
LOG_FILE="/media/ubantu_root/16TB_21/BXY/scAPA/PAC/mouse_sperm/scraps/merge/sim_data_res/performance_log.txt"
...
for sample in merge;
do echo $sample;
cd /media/ubantu_root/16TB_21/BXY/scAPA/PAC/mouse_sperm/scraps/${sample}
