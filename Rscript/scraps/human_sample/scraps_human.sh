...
#output folder
cd /media/ubantu_root/16TB_21/BXY/scAPA/PAC/human_covid_pbmc/scraps/GSM4712885/sim_data_res
#mkdir pas1_gn5000_bn2000_rep1 pas1_gn5000_bn2000_rep2 pas1_gn5000_bn2000_rep3

# Set the log file path
LOG_FILE="/media/ubantu_root/16TB_21/BXY/scAPA/PAC/human_covid_pbmc/scraps/GSM4712885/sim_data_res/performance_log.txt"
...
do echo $sample;
cd /media/ubantu_root/16TB_21/BXY/scAPA/PAC/human_covid_pbmc/scraps/${sample}
