...
do echo $sample;
cd /mnt/T20T-6d12/BXY/scAPA/sim_data/PAC/mouse_sperm/scapa
mkdir ${sample}
mkdir ${sample}/temp
cd ${sample}/temp

##filterbam and PCR dedup
/mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/softwares/Drop-seq_tools-2.2.0/FilterBam TAG_RETAIN=UB I=/mnt/T20T-6d12/BXY/scAPA/sim_data/SRA/mouse_sperm/${sample}.bam O=UB.${sample}.bam;
...
findPeaks Tagdirectory -size 50 -fragLength 98 -minDist 1 -strand separate -o Peakfile;
done
