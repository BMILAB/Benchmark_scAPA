...
do echo $sample;
cd /mnt/T20T-d2bf/BXY/scAPA/sim.data/PAC/human_GSM4712885/scapa
mkdir ${sample}
mkdir ${sample}/temp
cd ${sample}/temp
##filterbam and PCR dedup
/mnt/user/BXY/software/Drop-seq_tools-2.2.0/FilterBam TAG_RETAIN=UB I=/mnt/T20T-d2bf/BXY/scAPA/sim.data/SRA/human_GSM4712885/${sample}.bam O=UB.${sample}.bam;
...
findPeaks Tagdirectory -size 50 -fragLength 91 -minDist 1 -strand separate -o Peakfile;
done
