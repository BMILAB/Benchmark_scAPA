...
## output dir----
out_path='/mnt/T20T-d2bf/BXY/scAPA/sim.data/PAC/human_GSM4712885/sierra'
...
reference.file <-'/mnt/user/BXY/ref_file/GRch38fa+gtf/genecode/v34/gencode.v34.annotation.gtf' 
