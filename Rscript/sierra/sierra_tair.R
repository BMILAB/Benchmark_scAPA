...
## output dir----
out_path='/mnt/T20T-d2bf/BXY/scAPA/sim.data/PAC/tair_GSM3490690/sierra'
...
reference.file <-'/mnt/user/BXY/ref_file/TAIR/Arabidopsis_thaliana.TAIR10.49.gtf' 
...
chrs=c(as.character(1:5))  #Arabidopsis
...
raw.seq <- BSgenome::seqnames(bsgenome)
print(raw.seq)
...
seqlevels(bsgenome) <- new.seq[seqlevels(bsgenome)]

print(seqnames(bsgenome))
