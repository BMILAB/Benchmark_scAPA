...
###input file path------
file.path="/mnt/T20T-6d12/BXY/scAPA/sim_data/SRA/tair_GSM3490690"
...
bam=paste0(input.path,"/",GSM,".Chr.bam")
...
###output file path-----
output.path=paste0("/mnt/T20T-6d12/BXY/scAPA/sim_data/PAC/tair_GSM3490690/infernape","/",GSM)
...
genome.ref="/mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/ref_file/TAIR10/TAIR10_infernape_ref.csv"

gene.start=1
gene.end=299009

pas.ref="/mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/scAPA/scAPA_tools/Infernape/Infernape_reference/TAIR10/filter.refpa.tair10.csv"
