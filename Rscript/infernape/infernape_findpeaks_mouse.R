...
###input file path------
file.path="/mnt/T20T-6d12/BXY/scAPA/sim_data/SRA/mouse_sperm"
...
###output file path-----
output.path=paste0("/mnt/T20T-6d12/BXY/scAPA/sim_data/PAC/mouse_sperm/infernape","/",GSM)
#output.path=paste0("/mnt/T20T-6d12/BXY/scAPA/time.test/mouse.brain/infernape")
...
genome.ref="/mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/ref_file/GRcm38fa+gtf/GRcm38_infernape_ref.csv"
#mouse_v25:1872052(55401gene);human_v34:2912496(60669gene);human_v44:3424189(62700gene)
gene.start=1
gene.end=1872052

pas.ref="/mnt/64cf3476-350c-46ad-bc48-574fa64a0334/test/BXY/scAPA/scAPA_tools/Infernape/data/PAS_withinfo.csv"
