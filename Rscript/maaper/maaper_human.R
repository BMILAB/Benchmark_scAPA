...
pas_annotation = readRDS("/mnt/user/BXY/scAPA/scAPA_tools/supplementary_data/MAAPER/PolyA_DB/human.PAS.hg38.rds")
gtf = "/mnt/user/BXY/ref_file/GRch38fa+gtf/genecode/v34/gencode.v34.annotation.gtf"

## input path----
input_path='/mnt/T20T-d2bf/BXY/scAPA/sim.data/SRA/human_GSM4712885'

## output dir----
out_path='/mnt/T20T-d2bf/BXY/scAPA/sim.data/PAC/human_GSM4712885/maaper'
